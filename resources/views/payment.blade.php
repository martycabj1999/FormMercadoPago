    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <label style="color:green;">{{$payment}}</label>
                <div class="card-body">
                    <form action="{{route('pay')}}" method="POST" id="paymentForm">
                        @csrf
                        <div class="row">
                            <div class="col-auto">
                                <label>Cuanto quisieras pagar?</label>
                                <input
                                    type="number"
                                    min="5"
                                    step="0.01"
                                ...
                                <small class="form-text text-muted">
                                    Use valores con hasta dos posiciones decimales, usando "."
                                </small>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <label>Selecciona una plataforma de pago:</label>
                                    <div class="form-group" id="toggler">
                                        ...
                                        @foreach ($paymentPlatforms as $paymentPlatform)
                                            <div
                                                ...
                                                data-parent="#toggler"
                                            >
                                                @includeIf('mercadopago.' . strtolower($paymentPlatform->name) . '-collapse')
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
